...
public class Queue<E> {
	...
	public class DeckOfCards {
		...
		public void cardInsert(String arr[][]) {
		...
		public void cardShuffle(String arr[][]) {
		...
		public void swap(String arr[][], int x1, int x2, int x3, int x4) {
			String temp = arr[x1][x2];
			arr[x1][x2] = arr[x3][x4];
			arr[x3][x4] = temp;
		}

		public Queue<Queue<String>> cardSort(String playercard[][]) {
